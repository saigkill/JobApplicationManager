...
pdfkeywords={Manns, Mayen, Bewerbung, IT-Support, Linux, Windows, Programmierer, Buchautor, Schriftsteller, Geschäftsprozess} %%
}
\usepackage{graphicx}
\usepackage{xltxtra}
...
\section{Kontakt}
~
\includegraphics[width=5cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/userpic.jpg}
~
\mystreet
\mycity
Germany
...
\myphone
~
\href{mailto:Sascha.Manns@outlook.de}{Sascha.Manns@outlook.de}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/email.png}
\href{http://saschamanns.de}{saschamanns.de}\includegraphics[width=0.3cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/aboutme.png}
Geburtsdatum: 01.10.1979
\section{Social Media}
%\href{https://www.xing.com/profile/SaschaZyroslawKyrill_Manns}{SaschaManns}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/xing.png}
\href{https://www.linkedin.com/in/saigkill}{saigkill}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/linkedin.png}
\href{https://www.facebook.com/sascha.manns}{sascha.manns}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/facebook.png}
\href{https://twitter.com/saigkill}{saigkill}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/twitter.png}
\href{https://wakatime.com/@saigkill}{saigkill}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/wakatime.jpg}
\href{https://codestats.net/users/saigkill}{saigkill}\includegraphics[width=0.4cm]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/codestats.png}
\end{aside}
...
\section{Sprachen}
\begin{itemize}
	\item Deutsch \progressbar[linecolor=blue,tickscolor=orange,emptycolor=white,filledcolor=blue]{1.0}
	\item Englisch \progressbar[linecolor=blue,tickscolor=orange,emptycolor=white,filledcolor=blue]{0.8}
\end{itemize}
...
\begin{center}
\includegraphics[scale=0.7]{$HOME/AppData/Roaming/JobApplicationManager/Pictures/signatur.png} \\
\begin{tabular}{@{}l@{}}
